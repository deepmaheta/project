                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row['firstnm']; ?></td>
                                            <td><?php echo $row['lastnm']; ?></td>
                                            <td><?php echo $row['email']; ?></td>
                                            <td><?php echo $row['number']; ?></td>
                                            <td><?php echo $row['address']; ?></td>
                                            <td><?php echo $row['modelcar']; ?></td>
                                            ...
                                            <td>
                                               <?php if($row['status']=='completed'){
                                                ...
                                                ?>
                                               <button><a href="statusservicechange.php?id=<?php echo $row['ID'] ?>">Done</a></button></td>
                                        <?php
                                               }
                                        ?>
                                            </tr>
